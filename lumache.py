...
from rakam_systems.ingestion import data_processor
from rakam_systems.ingestion import content_extractors
...
def test_vector_store_operations(vector_store_fixture):
    ...
    additional_pdf_extractor = content_extractors.PDFContentExtractor(
        parser_name="SimplePDFParser"
    )
